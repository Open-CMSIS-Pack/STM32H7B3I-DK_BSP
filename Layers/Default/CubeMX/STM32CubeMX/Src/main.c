...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_FMC|RCC_PERIPHCLK_OSPI
                              |RCC_PERIPHCLK_USB|RCC_PERIPHCLK_SDMMC
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : WIFI_GPIO_Pin WIFI_DATRDY_Pin ARDUINO_D10_Pin ARDUINO_D9_Pin
                           ARDUINO_D2_Pin ARDUINO_D7_Pin */
  GPIO_InitStruct.Pin = WIFI_GPIO_Pin|WIFI_DATRDY_Pin|ARDUINO_D10_Pin|ARDUINO_D9_Pin
                          |ARDUINO_D2_Pin|ARDUINO_D7_Pin;
  ...
  /*Configure GPIO pin : ARDUINO_D5_Pin */
