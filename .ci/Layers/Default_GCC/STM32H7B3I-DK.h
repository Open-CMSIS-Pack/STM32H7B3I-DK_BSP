...
#ifndef STM32H7B3I_DK_H_
#define STM32H7B3I_DK_H_
...
#define ARDUINO_UNO_D2      GPIO_PIN_ID_PORTI(9U)
#define ARDUINO_UNO_D3      GPIO_PIN_ID_PORTH(9U)
#define ARDUINO_UNO_D4      GPIO_PIN_ID_PORTE(2U)
#define ARDUINO_UNO_D5      GPIO_PIN_ID_PORTH(11U)
#define ARDUINO_UNO_D6      GPIO_PIN_ID_PORTH(10U)
#define ARDUINO_UNO_D7      GPIO_PIN_ID_PORTI(10U)
#define ARDUINO_UNO_D8      GPIO_PIN_ID_PORTF(10U)
#define ARDUINO_UNO_D9      GPIO_PIN_ID_PORTI(7U)
#define ARDUINO_UNO_D10     GPIO_PIN_ID_PORTI(0U)
#define ARDUINO_UNO_D14     GPIO_PIN_ID_PORTA(4U)
...
#define ARDUINO_UNO_UART    4           // UART4
