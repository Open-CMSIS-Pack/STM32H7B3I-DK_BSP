...
/*! \page vio_STM32H7B3I-DK Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red     (LD3)    | PG11
| vioLED1       | vioSignalOut.1 | LED blue    (LD2)    | PG2
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTG(11), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED1,    GPIO_PIN_ID_PORTG(2),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
