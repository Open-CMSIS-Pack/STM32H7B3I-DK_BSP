...
The **STMicroelectronics STM32H7B3I-DK Board Support Pack (BSP)**:
...
- [Examples/Blinky](https://github.com/Open-CMSIS-Pack/STM32H7B3I-DK_BSP/tree/main/Examples/Blinky) shows the basic usage of this board.

- [Board Layer](https://github.com/Open-CMSIS-Pack/STM32H7B3I-DK_BSP/tree/main/Layers/Default) for device-agnostic [Reference Applications](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/blob/main/docs/ReferenceApplications.md) that implements these API interfaces:

| Provided API Interface        | Description
|:------------------------------|:------------------------------------------------------------------------------
| CMSIS_MCI                     | CMSIS-Driver MCI connected to microSD card slot (CN4)
| CMSIS_USART                   | CMSIS-Driver USART connected to STMod+ pins PMOD2-TX, PMOD3-RX (P1)
| CMSIS_USB_Device              | CMSIS-Driver USB Device connected to USB_OTG_HS connector (CN15)
| CMSIS_VIO                     | CMSIS-Driver VIO connected to LEDs (LD3, LD2) and USER button (B2)
...
By default the [Board Layers](https://github.com/Open-CMSIS-Pack/STM32H7B3I-DK_BSP/tree/main/Layers) are configured for the Arm Compiler 6 (AC6). Using STM32CubeMX it can be reconfigured for a different compiler. To configure it for the GCC compiler execute these steps:
